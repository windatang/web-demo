...
//@ts-ignore
import NunitoSans from '../fonts/english//Nunito_Sans/NunitoSans-Regular.ttf';
...
export const globalCss = ({theme}: any) => css`
  ...
  html, body {
    ...
    font-family: NunitoSans, Roboto, Helvetica, Arial, "华文细黑", "Microsoft YaHei", "微软雅黑", SimSun, "宋体", Heiti, "黑体", sans-serif;
    //font-family: Roboto;
