...
export const settingsSlice: Slice<SettingsState> = createSlice({
    ...
    initialState,
    reducers: {
        setTheme(state: { themeMode: any; }, action: PayloadAction<ThemeKeys>) {
            // localStore.setItem('ThemeType',action.payload)
            state.themeMode = action.payload

        },
        setLanguage(state: { language: any; }, action: PayloadAction<LanguageKeys>) {
        ...
        setPlatform(state: { platform: any; }, action: PayloadAction<keyof typeof PlatFormType>) {
